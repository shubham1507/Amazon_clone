...
#     merchant = models.OneToOneField(settings.AUTH_USER_MODEL,
...
class StaffUser(models.Model):
    profile_pic = models.FileField(default="")
    staff_id = models.OneToOneField(CustomUser, on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ProductReviews(models.Model):
    ...
    user_id = models.ForeignKey(CustomerUser, on_delete=models.CASCADE)
    review_image = models.FileField()
    rating = models.CharField(max_length=255, default="5")
    review = models.TextField(default="")
    created_at = models.DateTimeField(auto_now_add=True)
    is_active = models.IntegerField(default=1)
